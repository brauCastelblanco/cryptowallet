...
currencies = pd.read_csv('/Users/brauliocastelblancocastro/Desktop/currencies.csv')
raw_balance = pd.read_csv('/Users/brauliocastelblancocastro/Desktop/balance.csv')
transactions_history = pd.read_csv('/Users/brauliocastelblancocastro/Desktop/transactions_history.csv')
with open('/Users/brauliocastelblancocastro/Desktop/readme.md') as f:
    readme = f.read()
