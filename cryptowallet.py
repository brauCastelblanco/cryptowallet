...
currencies_file = requests.get('https://raw.githubusercontent.com/brauCastelblanco/cryptowallet/main/currencies.csv').content
raw_balance_file = requests.get('https://raw.githubusercontent.com/brauCastelblanco/cryptowallet/main/balance.csv').content
transactions_history_file = requests.get('https://raw.githubusercontent.com/brauCastelblanco/cryptowallet/main/transactions_history.csv').content
readme_file = requests.get('https://raw.githubusercontent.com/brauCastelblanco/cryptowallet/main/readme.md').content

currencies = pd.read_csv(io.StringIO(currencies_file.decode('utf-8')))
raw_balance = pd.read_csv(io.StringIO(raw_balance_file.decode('utf-8')))
transactions_history = pd.read_csv(io.StringIO(transactions_history_file.decode('utf-8')))
...
with st.expander('read.me'):
    st.markdown(str(readme_file, 'utf-8'))
